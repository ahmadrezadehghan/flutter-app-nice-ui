...
class new_khabar extends StatefulWidget {
  @override
  _new_khabarState createState() => _new_khabarState();
}

class _new_khabarState extends State<new_khabar> {
