...
class sh_t extends StatefulWidget {
  @override
  _sh_tState createState() => _sh_tState();
}

class _sh_tState extends State<sh_t> {
  @override
                ...
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      fillColor: t,
                      hintText: ' the subject of the complaint',
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      fillColor: t,
                      hintText: "the name of the southern company",
                      hintStyle: TextStyle(color: t, fontSize: 14),
                      border: InputBorder.none,
                    ),
                  ),
