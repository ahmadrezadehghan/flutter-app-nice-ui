...
Color b = Color.fromARGB(255, 230, 230, 230);
Color t = Color.fromARGB(255, 69, 69, 69);
Color w = Color.fromARGB(255, 255, 255, 255);
Color g = Color.fromARGB(255, 48, 196, 124);
double Size_width = 100;
double Size_font = 12;
double widget_curve = 12;
